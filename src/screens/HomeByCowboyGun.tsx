...
{dataCowboyGun.map((item, index) => (
        <>
      <View style={tw`mx-4`}>
        <Text style={tw`text-3xl font-semibold text-center mb-8 mt-10`}>
